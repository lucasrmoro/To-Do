...
public abstract class Hilt_ListTaskFragment<VB extends ViewBinding, VM extends ViewModel> extends BaseFragment<VB, VM> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ListTaskFragment_GeneratedInjector) this.generatedComponent()).injectListTaskFragment(UnsafeCasts.<ListTaskFragment>unsafeCast(this));
    }
  }
