...
public abstract class Hilt_EditTaskFragment<VB extends ViewBinding, VM extends ViewModel> extends BaseFragment<VB, VM> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((EditTaskFragment_GeneratedInjector) this.generatedComponent()).injectEditTaskFragment(UnsafeCasts.<EditTaskFragment>unsafeCast(this));
    }
  }
