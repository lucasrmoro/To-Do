...
public abstract class Hilt_CustomSplashFragment<VB extends ViewBinding, VM extends ViewModel> extends BaseFragment<VB, VM> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CustomSplashFragment_GeneratedInjector) this.generatedComponent()).injectCustomSplashFragment(UnsafeCasts.<CustomSplashFragment>unsafeCast(this));
    }
  }
